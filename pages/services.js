...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Professional tattoo training programs for aspiring artists. Learn from experienced professionals in a real studio environment. Courses cover everything from basic techniques to advanced skills and business practices. Our comprehensive curriculum includes hands-on practice, safety protocols, client communication, and portfolio development. We provide all necessary equipment and materials during training.",
      ...
      <section className="bg-white">
        ...
        <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center">
          ...
          <div className="relative z-20 text-center text-white px-4">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white/80">
              Our Services
            </h1>
