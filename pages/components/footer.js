          ...
          <div className="flex flex-col lg:flex-row w-full">
            ...
            <div className="w-full lg:w-1/4 px-2 lg:px-0">
              <div className="w-full lg:w-[80%] mb-5">
                ...
                <p className="text-base text-white mb-7 mt-4">
                  Your premier destination for artistic tattoos and piercings.
                </p>
                <div className="text-white">
                  <p className="flex items-center text-sm font-medium group">
                    ...
                    <span className="hover:text-[#F7A600] transition-colors duration-300">
                      095163 62594
                    </span>
                  </p>
                </div>
            ...
            <div className="w-full lg:w-3/4 flex flex-col sm:flex-row lg:ml-16">
              <div className="w-full sm:w-1/2 lg:w-1/3 px-4">
                <div className="w-full mb-10">
                  <h4 className="text-white text-lg font-semibold mb-6 relative inline-block after:content-[''] after:absolute after:w-1/2 after:h-[2px] after:bg-[#F7A600] after:left-0 after:bottom-[-8px]">
                    Quick Links
                  </h4>
                      ...
                      >
                        ...
                        <div className="ml-4">
                          <p className="text-[15px] text-white/90">
                            Mini chopati ki gali, near gurudwara
                          </p>
                          <p className="text-[15px] text-white/90">
                            Freeganj, Ujjain
                          </p>
        ...
        <div className="border-t border-gray-700/50">
          <div className="lg:max-w-[1300px] mx-auto py-6 px-5 flex flex-wrap flex-col text-center">
            <p className="text-white font-semibold text-base mb-2">
              ...
              <span className="font-medium">Ink City</span> - The Tattoo Studio.
              All rights reserved.
            </p>
